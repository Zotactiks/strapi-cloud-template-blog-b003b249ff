...
export interface ApiDonationPageDonationPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Content for the donations page.';
    displayName: 'Donations Page';
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    discordInviteUrl: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    announcementEmbedUrl: Schema.Attribute.String;
    announcementTitle: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaLabel: Schema.Attribute.String;
...
export interface ApiLegalSectionLegalSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'legal_sections';
  info: {
    description: 'Privacy policy and terms sections.';
    displayName: 'Legal Section';
    pluralName: 'legal-sections';
    singularName: 'legal-section';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiRuleRule extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    body: Schema.Attribute.RichText;
    category: Schema.Attribute.Enumeration<['city', 'in-game']> &
...
export interface ApiStaffMemberStaffMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Staff team members.';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mainCharacter: Schema.Attribute.String;
    ...
    team: Schema.Attribute.Enumeration<
      ['leadership', 'senior-management', 'management', 'staff']
    > &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::legal-section.legal-section': ApiLegalSectionLegalSection;
